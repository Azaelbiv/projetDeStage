...
<body>
        ...
        <form action="" class="formulaire-stage encadrant">
            <p class="form-bar"><button class="stg-btn"><i class="fas fa-circle-plus"></i>Ajouter encadrant</button></p>
            <label for="Lname">Nom et Prenom:</label>
            <input id="Lname" class="input-stage encad1" type="text" placeholder="Saisir nom et prenom..." required><br>
            <label for="emailEnca">Email:</label>
            <input id="emailEnca" class="input-stage encad2" type="email" placeholder="Saisir email..." required><br>
            <label for="specialite">Specialité:</label>
            <input id="specialite" class="input-stage encad2" type="text" placeholder="Saisir specialite..." required><br>
            <label for="tel">Téléphone:</label>
            <input id="tel" class="input-stage encad4" type="tel" placeholder="Saisir numéro de téléphone..." required><br>
            <label for="cvEnca">CV:</label>
            <input id="cvEnca" class="input-stage encad5" type="file" required><br>
            <input id="btnEncad" class="validation btnEncad" type="submit" value="Ajouter">
        </form>
        </div>
    <footer>
        <div class="footerbox">
