...
<body>
    <div class="contenair">
        ...
        <div class="formAbsence">
        <form action="" class="formulaire-stage absence">
            <p class="form-bar"><button class="stg-btn"><i class="fas fa-circle-plus"></i>Marquer absence</button></p>
            <label for="NomAbsence">Nom et Prénom:</label>
            <input id="NomAbsence" class="input-stage stg1" type="text" placeholder="nom et é du stagiaire..." required><br>
            <label for="DebutAbs">Début d'absence:</label>
            <input id="DebutAbs" class="input-stage stg2" type="date" required><br>
            <label for="FinAbs">Fin d'absence:</label>
            <input id="FinAbs" class="input-stage stg3" type="date" required><br>
            <label for="justif">Justification:</label>
            <input id="justif" class="input-stage stg3" type="file" required><br>
            <label for="justifiAbs">Autre justification:</label><br>
            <textarea name="texterea" id="justifiAbs" cols="30" rows="5" class="input-stage stg4" placeholder="Entrer une description ici..."></textarea><br>
            <input  class="MarquerAbs" type="submit" value="Marquer">
        </form>
        </div>
    <footer>
        <div class="footerbox">
